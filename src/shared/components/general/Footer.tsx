...
export function Footer() {
  ...
  return (
    <footer className="app-footer shrink-0 border-t border-(--border-soft) bg-(--bg-surface) text-(--text-secondary)">
      <div className="mx-auto flex max-w-6xl flex-col gap-4 px-4 py-4 md:flex-row md:items-center md:justify-between">
        {/* DISCLAIMER */}
        <p className="text-[12px] leading-relaxed md:max-w-md">
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            ...
            className="group flex h-11 w-11 items-center justify-center rounded-full transition hover:bg-black/5 dark:hover:bg-white/10"
          >
            <svg
              viewBox="0 0 24 24"
          ...
          {/* BUY ME A COFFEE */}
          <BuyMeACoffeeButton className="ml-2" />
        </div>
      </div>
    </footer>
  )
